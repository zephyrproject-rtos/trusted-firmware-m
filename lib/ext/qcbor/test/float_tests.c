...
static const uint8_t spExpectedSmallest[] = {
    ...
    0x69, 0x6E, 0x66, 0x69, 0x6E, 0x69, 0x74, 0x69, 0x74, 0x79,
    0xF9, 0xFC, 0x00, 0x63, 0x4E, 0x61, 0x4E,
/*
    IAR NAN definition different from GCC or ARMCLANG
    Because the test checks the NAN payload too
    (which is not relevant in a testcase,
    which only have to check if the output is NAN or not),
    we have to define different test values for IAR build.
*/
