...
/**
  ...
  * @return     None
  *
        This function stop the timers within specified smartcard module, \b not timer module.
  */
...
/**
  ...
  * @return     None
  *
        This function start the timer within specified smartcard module, \b not timer module.
        Depend on the timer operating mode, timer may not start counting immediately and starts when condition match.
  */
...
/**
  ...
  * @return     None
  *
        This function stop the timer within specified smartcard module, \b not timer module.
  */
