...
typedef enum _ARM_PPC_CORSTONE315_SecAttr {
    ARM_PPC_CORSTONE315_SECURE_CONFIG = 0,    /*!< Secure access */
    ARM_PPC_CORSTONE315_NONSECURE_CONFIG,     /*!< Non-secure access */
} ARM_PPC_CORSTONE315_SecAttr;

/* Privilege attribute used to configure the peripheral */
typedef enum _ARM_PPC_CORSTONE315_PrivAttr {
    ARM_PPC_CORSTONE315_PRIV_AND_NONPRIV_CONFIG = 0, /*!< Privilege and non-privilege
                                             * access */
    ARM_PPC_CORSTONE315_PRIV_CONFIG,                 /*!< Privilege only access */
} ARM_PPC_CORSTONE315_PrivAttr;
...
/**
  ...
  \fn          ARM_DRIVER_VERSION PPC_CORSTONE315_GetVersion(void)
  \brief       Get driver version.
  \return      \ref ARM_DRIVER_VERSION

  \fn          int32_t PPC_CORSTONE315_Initialize(void)
  \brief       Initializes PPC Interface.
  \return      Returns Corstone-315 PPC error code.

  \fn          int32_t PPC_CORSTONE315_Uninitialize(void)
  \brief       De-initializes PPC Interface.
  \return      Returns Corstone-315 PPC error code.

  \fn          int32_t PPC_CORSTONE315_ConfigPrivilege(uint32_t periph,
  ...
  \fn          bool PPC_CORSTONE315_IsPeriphPrivOnly (uint32_t periph)
  ...
  \fn          int32_t PPC_CORSTONE315_ConfigSecurity(uint32_t periph,
                                                 ARM_PPC_CORSTONE315_SecAttr sec_attr)
  ...
  \fn          bool PPC_CORSTONE315_IsPeriphSecure (uint32_t periph)
  ...
  \fn          int32_t PPC_CORSTONE315_EnableInterrupt (void)
  \brief       Enables PPC interrupt.
  \return      Returns Corstone315 PPC error code.

  \fn          void PPC_CORSTONE315_DisableInterrupt (void)
  \brief       Disables PPC interrupt.

  \fn          void PPC_CORSTONE315_ClearInterrupt (void)
  \brief       Clears PPC interrupt.

  \fn          bool PPC_CORSTONE315_InterruptState (void)
 ...
 */
typedef struct _ARM_DRIVER_PPC_CORSTONE315 {
  ...
  int32_t             (*ConfigPrivilege)  (uint32_t periph, ARM_PPC_CORSTONE315_SecAttr sec_attr, ARM_PPC_CORSTONE315_PrivAttr priv_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
  ...
  int32_t             (*ConfigSecurity)   (uint32_t periph, ARM_PPC_CORSTONE315_SecAttr sec_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
...
} const ARM_DRIVER_PPC_CORSTONE315;
