...
/* Default Boot ROM layout on Corstone-315 with BL1:
 *
 * 0x0000_0000 BL1_1     (128 KB)
 *
 */

/* Default SRAM layout on Corstone-315 with BL1, BL2 and provisioning bundles:
 *
...
/* Default QSPI Flash layout on Corstone-315 with BL2 (multiple image boot):
 *
 ...
 * 0x007C_0000 Unused
 *
 * Default QSPI Flash layout on Corstone-315 with BL2 (single image boot):
 *
