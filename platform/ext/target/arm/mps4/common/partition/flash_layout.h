...
/* Default Boot ROM layout on MPS4 Corstone-3xx with BL1:
 *
 * 0x0000_0000 BL1_1     (128 KB)
 *
 */

/* Default SRAM layout on MPS4 Corstone-3xx with BL1, BL2 and provisioning bundles:
 *
 * 0x0000_0000 BL1_2        Copied from OTP                      (8 KB)
 * 0x0000_2000 BL2                                               (128 KB)
 * 0x0002_2000 Bundle area  Provisioning bundles are copied here (8 KB)
 * 0x0002_4000 CM Bundle    CM bundle should be loaded here      (26.5 KB)
 * 0x0002_AA00 DM Bundle    DM bundle should be loaded here      (26.0234 KB)
 *
 */

/* Default QSPI Flash layout on MPS4 Corstone-3xx with BL2 (multiple image boot):
 *
 ...
 * 0x007C_0000 Unused
 *
 * Default QSPI Flash layout on MPS4 Corstone-3xx with BL2 (single image boot):
 *
...
/* Flash device name used by BL1
 * Name is defined in flash driver file: Driver_Flash.c
 */
#define FLASH_DEV_NAME_BL1 Driver_FLASH1
