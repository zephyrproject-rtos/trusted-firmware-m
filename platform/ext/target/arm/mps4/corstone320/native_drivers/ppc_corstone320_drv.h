...
/**
 * \file ppc_corstone320_drv.h
 * \brief Generic driver for Corstone-320 Peripheral Protection Controllers (PPC).
 */

#ifndef __PPC_CORSTONE320_DRV_H__
#define __PPC_CORSTONE320_DRV_H__
...
/* Corstone-320 PPC names */
enum ppc_corstone320_name_t {
    PPC_CORSTONE320_MAIN0 = 0,        /*!< MAIN PPC 0 */
    PPC_CORSTONE320_MAIN_EXP0,        /*!< Expansion 0 MAIN PPC */
    PPC_CORSTONE320_MAIN_EXP1,        /*!< Expansion 1 MAIN PPC */
    PPC_CORSTONE320_MAIN_EXP2,        /*!< Expansion 2 MAIN PPC */
    PPC_CORSTONE320_MAIN_EXP3,        /*!< Expansion 3 MAIN PPC */
    PPC_CORSTONE320_PERIPH0,          /*!< PERIPH PPC0 */
    PPC_CORSTONE320_PERIPH1,          /*!< PERIPH PPC1 */
    PPC_CORSTONE320_PERIPH_EXP0,      /*!< Expansion 0 PERIPH PPC */
    PPC_CORSTONE320_PERIPH_EXP1,      /*!< Expansion 1 PERIPH PPC */
    PPC_CORSTONE320_PERIPH_EXP2,      /*!< Expansion 2 PERIPH PPC */
    PPC_CORSTONE320_PERIPH_EXP3,      /*!< Expansion 3 PERIPH PPC */
    CORSTONE320_PPC_MAX_NUM
};

/* Corstone-320 PPC device configuration structure */
struct ppc_corstone320_dev_cfg_t {
    ...
    enum ppc_corstone320_name_t ppc_name;
};

/* Corstone-320 PPC device data structure */
struct ppc_corstone320_dev_data_t {
...
/* Corstone-320 PPC device structure */
struct ppc_corstone320_dev_t {
    const struct ppc_corstone320_dev_cfg_t* const cfg;  /*!< PPC configuration */
    struct ppc_corstone320_dev_data_t* const data;      /*!< PPC data */
};

/* Security attribute used to configure the peripherals */
enum ppc_corstone320_sec_attr_t {
    PPC_CORSTONE320_SECURE_ACCESS = 0,    /*! Secure access */
    PPC_CORSTONE320_NONSECURE_ACCESS,     /*! Non-secure access */
};

/* Privilege attribute used to configure the peripherals */
enum ppc_corstone320_priv_attr_t {
    PPC_CORSTONE320_PRIV_AND_NONPRIV_ACCESS = 0, /*! Privilege and NonPrivilege
                                                access */
    PPC_CORSTONE320_PRIV_ONLY_ACCESS,            /*! Privilege only access */
};

/* ARM PPC error codes */
enum ppc_corstone320_error_t {
    PPC_CORSTONE320_ERR_NONE = 0,      /*!< No error */
    PPC_CORSTONE320_ERR_INVALID_PARAM, /*!< PPC invalid parameter error */
    PPC_CORSTONE320_ERR_NOT_INIT,      /*!< PPC not initialized */
    PPC_CORSTONE320_ERR_NOT_PERMITTED  /*!< PPC Operation not permitted */
};

/**
 * \brief Initialize the PPC device.
 *
 * \param[in] dev       PPC device \ref ppc_corstone320_dev_t
 *
 * \return Returns error code as specified in \ref ppc_corstone320_error_t
 *
...
#endif
#endif /* __PPC_CORSTONE320_DRV_H__ */
