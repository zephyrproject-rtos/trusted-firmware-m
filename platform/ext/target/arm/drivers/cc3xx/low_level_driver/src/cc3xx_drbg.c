    ...
    const uint8_t *personalization, size_t personalization_len)
{
    ...
    case CC3XX_DRBG_HMAC:
        return cc3xx_lowlevel_drbg_hmac_instantiate(
            &state->hmac,
            entropy, entropy_len,
            nonce, nonce_len,
            personalization, personalization_len);
    ...
    case CC3XX_DRBG_HASH:
        return cc3xx_lowlevel_drbg_hash_init(
            &state->hash,
            entropy, entropy_len,
            nonce, nonce_len,
            personalization, personalization_len);
...
#ifdef CC3XX_CONFIG_DRBG_HMAC_ENABLE
    case CC3XX_DRBG_HMAC:
        return cc3xx_lowlevel_drbg_hmac_generate(
            &state->hmac, len_bits, returned_bits, additional_input, additional_input_len);
#endif /* CC3XX_CONFIG_DRBG_HMAC_ENABLE */
#ifdef CC3XX_CONFIG_DRBG_HASH_ENABLE
    case CC3XX_DRBG_HASH:
        return cc3xx_lowlevel_drbg_hash_generate(
...
#ifdef CC3XX_CONFIG_DRBG_HMAC_ENABLE
    case CC3XX_DRBG_HMAC:
        return cc3xx_lowlevel_drbg_hmac_reseed(
            &state->hmac, entropy, entropy_len, additional_input, additional_input_len);
#endif /* CC3XX_CONFIG_DRBG_HMAC_ENABLE */
#ifdef CC3XX_CONFIG_DRBG_HASH_ENABLE
    case CC3XX_DRBG_HASH:
        return cc3xx_lowlevel_drbg_hash_reseed(
...
#ifdef CC3XX_CONFIG_DRBG_HMAC_ENABLE
    case CC3XX_DRBG_HMAC:
        return cc3xx_lowlevel_drbg_hmac_uninit(&state->hmac);
#endif /* CC3XX_CONFIG_DRBG_HMAC_ENABLE */
#ifdef CC3XX_CONFIG_DRBG_HASH_ENABLE
    case CC3XX_DRBG_HASH:
        return cc3xx_lowlevel_drbg_hash_uninit(&state->hash);
#endif /* CC3XX_CONFIG_DRBG_HASH_ENABLE */
    default:
        return CC3XX_ERR_DRBG_INVALID_ID;
    }
