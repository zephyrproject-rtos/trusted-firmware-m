...
#ifndef __DRIVER_USART_PL011_H__
#define __DRIVER_USART_PL011_H__
...
static inline int32_t ARM_USARTx_Send(UARTx_Resources* uart_dev, const void *data,
                                      uint32_t num)
{
...
static inline int32_t ARM_USARTx_Control(UARTx_Resources* uart_dev, uint32_t control,
                                         uint32_t arg)
{
...
/*
 * \brief Macro for USART PL011 Driver
 *
 * \param[in]  USART_DEV          Native driver device
 *                                \ref uart_pl011_dev_t
 * \param[out] USART_DRIVER_NAME  Resulting Driver name
 */

#define ARM_DRIVER_USART_PL011(USART_DEV, USART_DRIVER_NAME)                  \
...
#endif  /* __DRIVER_USART_PL011_H__ */
