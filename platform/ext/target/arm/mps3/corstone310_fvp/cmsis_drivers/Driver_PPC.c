...
ARM_DRIVER_VERSION PPC_CORSTONE310_GetVersion(void)
{
...
#if (RTE_PPC_CORSTONE310_MAIN_EXP0)
...
#if (RTE_PPC_CORSTONE310_MAIN_EXP1)
...
#if (RTE_PPC_CORSTONE310_MAIN_EXP2)
...
#if (RTE_PPC_CORSTONE310_MAIN_EXP3)
...
#if (RTE_PPC_CORSTONE310_PERIPH0)
...
#if (RTE_PPC_CORSTONE310_PERIPH1)
...
#if (RTE_PPC_CORSTONE310_PERIPH_EXP0)
...
#if (RTE_PPC_CORSTONE310_PERIPH_EXP1)
...
#if (RTE_PPC_CORSTONE310_PERIPH_EXP2)
...
#if (RTE_PPC_CORSTONE310_PERIPH_EXP3)
