...
/**
  ...
  \fn          ARM_DRIVER_VERSION PPC_CORSTONE310_GetVersion(void)
  \brief       Get driver version.
  \return      \ref ARM_DRIVER_VERSION

  \fn          int32_t PPC_CORSTONE310_Initialize(void)
  \brief       Initializes PPC Interface.
  \return      Returns Corstone-310 PPC error code.

  \fn          int32_t PPC_CORSTONE310_Uninitialize(void)
  ...
  \fn          bool PPC_CORSTONE310_IsPeriphPrivOnly (uint32_t periph)
  ...
  \fn          bool PPC_CORSTONE310_IsPeriphSecure (uint32_t periph)
  ...
  \fn          int32_t PPC_CORSTONE310_EnableInterrupt (void)
  \brief       Enables PPC interrupt.
  \return      Returns Corstone310 PPC error code.

  \fn          void PPC_CORSTONE310_DisableInterrupt (void)
  \brief       Disables PPC interrupt.

  \fn          void PPC_CORSTONE310_ClearInterrupt (void)
  \brief       Clears PPC interrupt.

  \fn          bool PPC_CORSTONE310_InterruptState (void)
