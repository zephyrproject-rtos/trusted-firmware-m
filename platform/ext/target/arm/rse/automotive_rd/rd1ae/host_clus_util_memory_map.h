...
/**
 * \file host_clus_util_memory_map.h
 * \brief This file contains addresses that are defined in the cluster utility
 *        memory map.
 */

#ifndef __HOST_CLUS_UTIL_MEMORY_MAP_H__
#define __HOST_CLUS_UTIL_MEMORY_MAP_H__
 ...
 */
/* SMCF components base address */
#define HOST_CLUS_UTIL_SMCF_OFF_ADDR_PHYS_BASE        0x00000000ULL
/* SMCF components end address */
#define HOST_CLUS_UTIL_SMCF_OFF_ADDR_PHYS_LIMIT       0x000FFFFFULL
...
#endif /* __HOST_CLUS_UTIL_MEMORY_MAP_H__ */
