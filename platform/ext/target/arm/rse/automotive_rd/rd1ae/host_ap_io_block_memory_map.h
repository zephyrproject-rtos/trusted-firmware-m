...
/**
 * \file host_ap_io_block_memory_map.h
 * \brief This file contains addresses that are defined in the application
 *        processor (AP) memory map for IO Block.
 */

#ifndef __HOST_AP_IO_BLOCK_MEMORY_MAP_H__
#define __HOST_AP_IO_BLOCK_MEMORY_MAP_H__
...
#endif /* __HOST_AP_IO_BLOCK_MEMORY_MAP_H__ */
