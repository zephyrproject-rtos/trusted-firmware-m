...
enum tfm_plat_err_t __attribute__((section("DO_PROVISION"))) do_provision(void) {
    ...
    INFO("Generating runtime OTP encryption key\n");
    ...
    INFO("Provisioning runtime OTP encryption key\n");
    ...
    INFO("Provisioning BL2 encryption key\n");
    ...
    INFO("Provisioning secure image encryption key\n");
    ...
    INFO("Provisioning non-secure image encryption key\n");
    ...
    INFO("Provisioning host secure ROTPK\n");
    ...
    INFO("Provisioning host non-secure ROTPK\n");
    ...
    INFO("Provisioning host CCA ROTPK\n");
    ...
    INFO("Provisioning attestation implementation ID\n");
    ...
    INFO("Provisioning attestation verification service URL\n");
    ...
    INFO("Provisioning attestation profile definition\n");
    ...
    INFO("Provisioning secure debug public key\n");
...
#if RSE_AMOUNT > 1
    INFO("Provisioning sender routing table\n");
    ...
    INFO("Provisioning receiver routing table\n");
