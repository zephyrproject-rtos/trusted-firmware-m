...
#if defined(CYMEM_CM33_0_S_CUSTOM_PARTITION_MEMORY_OFFSET)
/******************** Test memory region for isolation test *******************/
#define IFX_TEST_CUSTOM_PARTITION_MEMORY_OFFSET       CYMEM_CM33_0_S_CUSTOM_PARTITION_MEMORY_OFFSET
#define IFX_TEST_CUSTOM_PARTITION_MEMORY_ADDR         CYMEM_CM33_0_S_CUSTOM_PARTITION_MEMORY_S_START
#define IFX_TEST_CUSTOM_PARTITION_MEMORY_SIZE         CYMEM_CM33_0_S_CUSTOM_PARTITION_MEMORY_SIZE
#define IFX_TEST_CUSTOM_PARTITION_MEMORY_LOCATION     CYMEM_CM33_0_S_CUSTOM_PARTITION_MEMORY_LOCATION
#endif
