...
#ifndef __PPC_ALCOR_DRIVER_H__
#define __PPC_ALCOR_DRIVER_H__
...
typedef enum _PPC_ALCOR_SecAttr {
    PPC_ALCOR_SECURE_CONFIG = 0,    /*!< Secure access */
    PPC_ALCOR_NONSECURE_CONFIG,     /*!< Non-secure access */
} PPC_ALCOR_SecAttr;

/* Privilege attribute used to configure the peripheral */
typedef enum _PPC_ALCOR_PrivAttr {
    PPC_ALCOR_PRIV_AND_NONPRIV_CONFIG = 0, /*!< Privilege and non-privilege
                                             * access */
    PPC_ALCOR_PRIV_CONFIG,                 /*!< Privilege only access */
} PPC_ALCOR_PrivAttr;
...
/**
  ...
  \fn          ARM_DRIVER_VERSION PPC_ALCOR_GetVersion(void)
  \brief       Get driver version.
  \return      \ref ARM_DRIVER_VERSION

  \fn          int32_t PPC_ALCOR_Initialize(void)
  \brief       Initializes PPC Interface.
  \return      Returns ALCOR PPC error code.

  \fn          int32_t PPC_ALCOR_Uninitialize(void)
  \brief       De-initializes PPC Interface.
  \return      Returns ALCOR PPC error code.

  \fn          int32_t PPC_ALCOR_ConfigPrivilege(uint32_t periph,
  ...
  \fn          bool PPC_ALCOR_IsPeriphPrivOnly (uint32_t periph)
  ...
  \fn          int32_t PPC_ALCOR_ConfigSecurity(uint32_t periph,
                                                 PPC_ALCOR_SecAttr sec_attr)
  ...
  \fn          bool PPC_ALCOR_IsPeriphSecure (uint32_t periph)
  ...
  \fn          int32_t PPC_ALCOR_EnableInterrupt (void)
  \brief       Enables PPC interrupt.
  \return      Returns ALCOR PPC error code.

  \fn          void PPC_ALCOR_DisableInterrupt (void)
  \brief       Disables PPC interrupt.

  \fn          void PPC_ALCOR_ClearInterrupt (void)
  \brief       Clears PPC interrupt.

  \fn          bool PPC_ALCOR_InterruptState (void)
 ...
 */
typedef struct _DRIVER_PPC_ALCOR {
  ...
  int32_t             (*ConfigPrivilege)  (uint32_t periph, PPC_ALCOR_SecAttr sec_attr, PPC_ALCOR_PrivAttr priv_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
  ...
  int32_t             (*ConfigSecurity)   (uint32_t periph, PPC_ALCOR_SecAttr sec_attr);  ///< Pointer to \ref ARM_PPC_ConfigPeriph : Configure a peripheral controlled by the PPC.
...
} const DRIVER_PPC_ALCOR;

#ifdef __cplusplus
}
#endif
#endif /* __PPC_ALCOR_DRIVER_H__ */
