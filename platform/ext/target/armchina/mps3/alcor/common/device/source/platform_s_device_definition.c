...
/* ALCOR PPC driver structures */
static struct ppc_alcor_dev_cfg_t PPC_ALCOR_MAIN0_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_MAIN0};
static struct ppc_alcor_dev_data_t PPC_ALCOR_MAIN0_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_MAIN0_DEV_S = {
    &PPC_ALCOR_MAIN0_CFG_S,
    &PPC_ALCOR_MAIN0_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_MAIN_EXP0_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_MAIN_EXP0};
static struct ppc_alcor_dev_data_t PPC_ALCOR_MAIN_EXP0_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_MAIN_EXP0_DEV_S = {
    &PPC_ALCOR_MAIN_EXP0_CFG_S,
    &PPC_ALCOR_MAIN_EXP0_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_MAIN_EXP1_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_MAIN_EXP1};
static struct ppc_alcor_dev_data_t PPC_ALCOR_MAIN_EXP1_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_MAIN_EXP1_DEV_S = {
    &PPC_ALCOR_MAIN_EXP1_CFG_S,
    &PPC_ALCOR_MAIN_EXP1_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_MAIN_EXP2_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_MAIN_EXP2};
static struct ppc_alcor_dev_data_t PPC_ALCOR_MAIN_EXP2_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_MAIN_EXP2_DEV_S = {
    &PPC_ALCOR_MAIN_EXP2_CFG_S,
    &PPC_ALCOR_MAIN_EXP2_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_MAIN_EXP3_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_MAIN_EXP3};
static struct ppc_alcor_dev_data_t PPC_ALCOR_MAIN_EXP3_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_MAIN_EXP3_DEV_S = {
    &PPC_ALCOR_MAIN_EXP3_CFG_S,
    &PPC_ALCOR_MAIN_EXP3_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH0_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH0};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH0_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH0_DEV_S = {
    &PPC_ALCOR_PERIPH0_CFG_S,
    &PPC_ALCOR_PERIPH0_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH1_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH1};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH1_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH1_DEV_S = {
    &PPC_ALCOR_PERIPH1_CFG_S,
    &PPC_ALCOR_PERIPH1_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH_EXP0_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH_EXP0};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH_EXP0_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH_EXP0_DEV_S = {
    &PPC_ALCOR_PERIPH_EXP0_CFG_S,
    &PPC_ALCOR_PERIPH_EXP0_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH_EXP1_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH_EXP1};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH_EXP1_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH_EXP1_DEV_S = {
    &PPC_ALCOR_PERIPH_EXP1_CFG_S,
    &PPC_ALCOR_PERIPH_EXP1_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH_EXP2_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH_EXP2};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH_EXP2_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH_EXP2_DEV_S = {
    &PPC_ALCOR_PERIPH_EXP2_CFG_S,
    &PPC_ALCOR_PERIPH_EXP2_DATA_S };

static struct ppc_alcor_dev_cfg_t PPC_ALCOR_PERIPH_EXP3_CFG_S = {
    .sacfg_base  = ALCOR_SACFG_BASE_S,
    .nsacfg_base = ALCOR_NSACFG_BASE_NS,
    .ppc_name = PPC_ALCOR_PERIPH_EXP3};
static struct ppc_alcor_dev_data_t PPC_ALCOR_PERIPH_EXP3_DATA_S = {
    .sacfg_ns_ppc  = 0,
    .sacfg_sp_ppc  = 0,
    .nsacfg_nsp_ppc = 0,
    .int_bit_mask = 0,
    .is_initialized = false };
struct ppc_alcor_dev_t PPC_ALCOR_PERIPH_EXP3_DEV_S = {
    &PPC_ALCOR_PERIPH_EXP3_CFG_S,
    &PPC_ALCOR_PERIPH_EXP3_DATA_S };
...
/* ARM MPC ALCOR driver structures */
...
static const struct tgu_armv8_m_mem_range_t TGU_DTCM_RANGE_S = {
    .base         = DTCM0_BASE_S,
    .limit        = DTCM1_BASE_S + DTCM_BLK_SIZE -1,
    .range_offset = 0x0,
    .attr         = TGU_SEC_ATTR_SECURE
};
...
static const struct tgu_armv8_m_mem_range_t TGU_DTCM_RANGE_NS = {
    .base         = DTCM0_BASE_NS,
    .limit        = DTCM1_BASE_NS + DTCM_BLK_SIZE -1,
    .range_offset = 0x0,
    .attr         = TGU_SEC_ATTR_NONSECURE
};
