...
/* Import PPC drivers */
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_MAIN0;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_MAIN_EXP0;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_MAIN_EXP1;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_MAIN_EXP2;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_MAIN_EXP3;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH0;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH1;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH_EXP0;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH_EXP1;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH_EXP2;
extern DRIVER_PPC_ALCOR Driver_PPC_ALCOR_PERIPH_EXP3;
...
static DRIVER_PPC_ALCOR *const ppc_bank_drivers[] = {
    &Driver_PPC_ALCOR_MAIN0,
    &Driver_PPC_ALCOR_MAIN_EXP0,
    &Driver_PPC_ALCOR_MAIN_EXP1,
    &Driver_PPC_ALCOR_MAIN_EXP2,
    &Driver_PPC_ALCOR_MAIN_EXP3,
    &Driver_PPC_ALCOR_PERIPH0,
    &Driver_PPC_ALCOR_PERIPH1,
    &Driver_PPC_ALCOR_PERIPH_EXP0,
    &Driver_PPC_ALCOR_PERIPH_EXP1,
    &Driver_PPC_ALCOR_PERIPH_EXP2,
    &Driver_PPC_ALCOR_PERIPH_EXP3,
};
...
{
    struct alcor_sysctrl_t *sysctrl =
                            (struct alcor_sysctrl_t *)ALCOR_SYSCTRL_BASE_S;
...
0xD0000000+--------+------+  +--------+      |       | +------------+
          | DDR4 7 |   S  |  | DDR4 7 |      |       | |     S      |
0xE0000000+--------+------+  +--------+------+-------+ +------------*/
    struct alcor_sacfg_t *sacfg = (struct alcor_sacfg_t*)ALCOR_SACFG_BASE_S;
    ...
    /* Configure SRAM */
    SAU->RNR = 1;
    SAU->RBAR = (CODE_MEM_BASE_NS & SAU_RBAR_BADDR_Msk);
    SAU->RLAR = ((CODE_MEM_BASE_NS + CODE_MEM_SIZE - 1) & SAU_RBAR_BADDR_Msk)
                | SAU_RLAR_ENABLE_Msk;
#endif
...
{
    struct alcor_sacfg_t *sacfg =
                                (struct alcor_sacfg_t*)ALCOR_SACFG_BASE_S;
    int32_t err = ARM_DRIVER_OK;

    /* Grant non-secure access to peripherals on MAIN EXP0 */
    err |= Driver_PPC_ALCOR_MAIN_EXP0.Initialize();
    err |= Driver_PPC_ALCOR_MAIN_EXP0.ConfigSecurity(
                                        GPIO0_MAIN_PPCEXP0_POS_MASK,
                                        PPC_ALCOR_NONSECURE_CONFIG);
    err |= Driver_PPC_ALCOR_MAIN_EXP0.ConfigSecurity(
    ...
    err |= Driver_PPC_ALCOR_MAIN_EXP1.Initialize();
    err |= Driver_PPC_ALCOR_MAIN_EXP1.ConfigSecurity(
    ...
    err |= Driver_PPC_ALCOR_PERIPH0.Initialize();
    err |= Driver_PPC_ALCOR_PERIPH0.ConfigSecurity(
    ...
    err |= Driver_PPC_ALCOR_PERIPH1.Initialize();
    err |= Driver_PPC_ALCOR_PERIPH1.ConfigSecurity(
                                        SLOWCLK_TIMER_PERIPH_PPC1_POS_MASK,
                                        PPC_ALCOR_NONSECURE_CONFIG);

    /* Grant non-secure access to peripherals on PERIPH EXP2 */
    err |= Driver_PPC_ALCOR_PERIPH_EXP2.Initialize();

    err |= Driver_PPC_ALCOR_PERIPH_EXP2.ConfigSecurity(
    ...
    err |= Driver_PPC_ALCOR_PERIPH_EXP2.ConfigPrivilege(
                                        UART0_PERIPH_PPCEXP2_POS_MASK,
                                        PPC_ALCOR_NONSECURE_CONFIG,
                                        PPC_ALCOR_PRIV_AND_NONPRIV_CONFIG);

    /* Initialize not used PPC drivers */
    err |= Driver_PPC_ALCOR_MAIN0.Initialize();
    err |= Driver_PPC_ALCOR_MAIN_EXP2.Initialize();
    err |= Driver_PPC_ALCOR_MAIN_EXP3.Initialize();
    err |= Driver_PPC_ALCOR_PERIPH_EXP0.Initialize();
    err |= Driver_PPC_ALCOR_PERIPH_EXP1.Initialize();
    err |= Driver_PPC_ALCOR_PERIPH_EXP3.Initialize();
...
void ppc_configure_to_secure(ppc_bank_t bank, uint32_t pos)
{
    ...
    if (ppc_driver) {
        ppc_driver->ConfigSecurity(pos, PPC_ALCOR_SECURE_CONFIG);
    }
}
...
void ppc_configure_to_non_secure(ppc_bank_t bank, uint32_t pos)
{
    ...
    ppc_driver = ppc_bank_drivers[bank];
    if (ppc_driver) {
        ppc_driver->ConfigSecurity(pos, PPC_ALCOR_NONSECURE_CONFIG);
    }
}
