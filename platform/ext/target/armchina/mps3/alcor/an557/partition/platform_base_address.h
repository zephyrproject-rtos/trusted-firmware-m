 ...
 * \brief This file defines all the peripheral base addresses for Alcor AN557 MPS3
 */
...
#define CODE_MEM_BASE_NS                 0x01000000 /* CODE Memory Non-Secure base address */
#define DTCM0_BASE_NS                    0x20000000 /* Data TCM block 0 Non-Secure base address */
#define DTCM1_BASE_NS                    0x20200000 /* Data TCM block 1 Non-Secure base address */
...
#define ALCOR_NSACFG_BASE_NS             0x40080000 /* Alcor Non-Secure Access Configuration Register Block Non-Secure base address */
...
#define ALCOR_SYSINFO_BASE_NS            0x48020000 /* Alcor System info Block Non-Secure base address */
...
#define CODE_MEM_BASE_S                  0x11000000 /* CODE Memory Secure base address */
#define DTCM0_BASE_S                     0x30000000 /* Data TCM block 0 Secure base address */
#define DTCM1_BASE_S                     0x30200000 /* Data TCM block 1 Secure base address */
...
#define ALCOR_SACFG_BASE_S               0x50080000 /* Alcor Secure Access Configuration Register Secure base address */
...
#define ALCOR_SYSINFO_BASE_S             0x58020000 /* Alcor System info Block Secure base address */
#define ALCOR_SYSCTRL_BASE_S             0x58021000 /* Alcor System control Block Secure base address */
#define ALCOR_SYSPPU_BASE_S              0x58022000 /* Alcor System Power Policy Unit Secure base address */
#define ALCOR_CPU0PPU_BASE_S             0x58023000 /* Alcor CPU 0 Power Policy Unit Secure base address */
#define ALCOR_MGMTPPU_BASE_S             0x58028000 /* Alcor Management Power Policy Unit Secure base address */
#define ALCOR_DBGPPU_BASE_S              0x58029000 /* Alcor Debug Power Policy Unit Secure base address */
...
#define ALCOR_EWIC_BASE                  0xE0047000 /* External Wakeup Interrupt Controller
                                                     * Access from Non-secure software is only allowed
                                                     * if AIRCR.BFHFNMINS is set to 1 */

/* Memory size definitions */
#define ITCM_SIZE       (0x00100000) /* 1 MB */
#define DTCM_BLK_SIZE   (0x00200000) /* 2 MB */
#define DTCM_BLK_NUM    (0x2)        /* Number of DTCM blocks */
#define CODE_MEM_SIZE   (0x00200000) /* 2 MB */
...
#define QSPI_MPC_BLK_SIZE    (0x10000)    /* 64 kB */
#define DDR4_MPC_BLK_SIZE    (0x100000)   /* 1 MB */

/* Defines for Driver MPC's */
/* SRAM -- 2 MB */
#define MPC_SRAM_RANGE_BASE_NS   (CODE_MEM_BASE_NS)
#define MPC_SRAM_RANGE_LIMIT_NS  (CODE_MEM_BASE_NS + CODE_MEM_SIZE-1)
#define MPC_SRAM_RANGE_OFFSET_NS (0x0)
#define MPC_SRAM_RANGE_BASE_S    (CODE_MEM_BASE_S)
#define MPC_SRAM_RANGE_LIMIT_S   (CODE_MEM_BASE_S + CODE_MEM_SIZE-1)
