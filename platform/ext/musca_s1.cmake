...
elseif (BUILD_TARGET_CFG)
    ...
    list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/musca_s1/attest_hal.c")
...
elseif (BUILD_TARGET_NV_COUNTERS)
    ...
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/musca_s1/dummy_nv_counters.c")
...
elseif (BUILD_BOOT_SEED)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/musca_s1/dummy_boot_seed.c")
endif()
...
elseif (BUILD_DEVICE_ID)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/musca_s1/dummy_device_id.c")
endif()
