...
/**
  ...
  *          actual SPI clock rate will be 6MHz.
    ...
    If u32BusClock >= system clock frequency for Secure, SPI peripheral clock source will be set to APB clock and DIVIDER will be set to 0.
  ...
  *         SPI bus clock cannot be faster than the system clock rate. User should set up carefully.
    ...
    In slave mode for Secure, the SPI peripheral clock rate will equal to APB clock rate.
    In slave mode for Non-Secure, the SPI peripheral clock rate will equal to the clock rate set in secure mode.
  */
